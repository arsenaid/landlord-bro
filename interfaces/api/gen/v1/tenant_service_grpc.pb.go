...
const (
	TenantService_CreateTenant_FullMethodName  = "/api.v1.TenantService/CreateTenant"
	TenantService_GetTenant_FullMethodName     = "/api.v1.TenantService/GetTenant"
	TenantService_ListTenants_FullMethodName   = "/api.v1.TenantService/ListTenants"
	TenantService_UpdateTenants_FullMethodName = "/api.v1.TenantService/UpdateTenants"
	TenantService_DeleteTenant_FullMethodName  = "/api.v1.TenantService/DeleteTenant"
)
...
type TenantServiceClient interface {
	...
	UpdateTenants(ctx context.Context, in *UpdateTenantRequest, opts ...grpc.CallOption) (*Tenant, error)
...
func (c *tenantServiceClient) UpdateTenants(ctx context.Context, in *UpdateTenantRequest, opts ...grpc.CallOption) (*Tenant, error) {
	out := new(Tenant)
	err := c.cc.Invoke(ctx, TenantService_UpdateTenants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TenantServiceServer interface {
	...
	UpdateTenants(context.Context, *UpdateTenantRequest) (*Tenant, error)
...
func (UnimplementedTenantServiceServer) UpdateTenants(context.Context, *UpdateTenantRequest) (*Tenant, error) {
...
func _TenantService_UpdateTenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTenantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).UpdateTenants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_UpdateTenants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).UpdateTenants(ctx, req.(*UpdateTenantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TenantService_UpdateTenants_Handler,
		},
		{
